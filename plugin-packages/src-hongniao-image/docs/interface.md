...
| `background` | string | 否 | `providerOptions.hongniao-image.background` | 如 `transparent/opaque/auto`。 |
| `output_format` | string | 否 | `providerOptions.hongniao-image.output_format` | 如 `png/jpeg/webp`。 |
| `output_compression` | integer | 否 | `providerOptions.hongniao-image.output_compression` | 压缩质量百分比，支持范围由模型决定。 |
| `moderation` | string | 否 | `providerOptions.hongniao-image.moderation` | 内容审核强度。 |
| `response_format` | string | 否 | `providerOptions.hongniao-image.response_format` | 兼容模型可选 `url` 或 `b64_json`。 |
| `style` | string | 否 | `providerOptions.hongniao-image.style` | DALL·E 系列兼容字段。 |
| `user` | string | 否 | `providerOptions.hongniao-image.user` | 终端用户追踪标识。 |
    ...
    "providers": [
      {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "type": "string",
            "mapping": "background",
            "description": "来自 providerOptions.hongniao-image.background。"
          },
          {
            "name": "output_format",
            "type": "string",
            "mapping": "output_format",
            "description": "来自 providerOptions.hongniao-image.output_format。"
          },
          {
            "name": "output_compression",
            "type": "integer",
            "mapping": "output_compression",
            "description": "来自 providerOptions.hongniao-image.output_compression。"
          },
          {
            "name": "moderation",
            "type": "string",
            "mapping": "moderation",
            "description": "来自 providerOptions.hongniao-image.moderation。"
          },
          {
        ...
        "create": {
          ...
          "body": {
            ...
            "background": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.hongniao-image.background"
              }
            },
            "output_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.hongniao-image.output_format"
              }
            },
            "output_compression": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.hongniao-image.output_compression"
              }
            },
            "moderation": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.hongniao-image.moderation"
              }
            },
            "response_format": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.hongniao-image.response_format"
              }
            },
            "style": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.hongniao-image.style"
              }
            },
            "user": {
              "$omitEmpty": {
                "$ref": "request.providerOptions.hongniao-image.user"
              }
            }
          },
          "files": [
